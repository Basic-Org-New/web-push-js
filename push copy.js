...
const notificationConfig = {
    ...
    popupPosition: 'top-center',  // Default popup position, options: 'top-center', 'top-right', 'top-left', 'bottom-center', 'bottom-left', 'bottom-right'
    ...
    popupTitle: 'liveyojana wants to notify you about the latest updates', // Popup title
